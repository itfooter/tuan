...
class ZTUcenter_integrate implements integrate {
	...
	{		
		...
		if($uid>0)
		{
				...
				if($ease_user&&$ease_user['user_pwd']=='')
				{
					...
					if($zt==1)
					{
						$GLOBALS['db']->query("update ".DB_PREFIX."user set user_pwd = '".$user_pwd."',code='@4!@#$%@' where id = ".$ease_user['id']);
					}
					else
	...
	public function uninstall()
	{
		if(file_exists(APP_ROOT_PATH."public/uc_config.php"))
		{
			...
			if(UC_CONNECT=='mysql')
			{
				...
				$ucdb->query("delete from ".UC_DBTABLEPRE."applications where type = 'EASETHINK_SHOP'");
			}
