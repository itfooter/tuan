...
class Taobao_api implements api_login {
	...
	{
		@session_start();
		$_SESSION['taobao_app_key'] = $this->api['config']['app_key'];
		$_SESSION['taobao_app_secret'] = $this->api['config']['app_secret'];
		$_SESSION['taobao_callback'] = get_domain().APP_ROOT."/api_callback.php?c=Taobao";
	...
	public function callback()
	{
		...
		if($verify_result) {//验证成功
			...
			app_redirect(url_pack("user#api_login"));
	...
	public function create_user()
	{
		...
		$user_data['taobao_id'] = $_SESSION['api_user_info']['id'];
