...
class Voucher_payment implements payment {
	...
	{
		$html = "<span>".$GLOBALS['payment_lang']['name']."：".$GLOBALS['payment_lang']['ecvsn'].
				"：<input type='text' value='' maxlength='20' name='ecvsn' class='f-input' />&nbsp;".
				$GLOBALS['payment_lang']['ecvpassword'].
				"：<input type='password' value='' maxlength='20' name='ecvpassword' class='f-input' />&nbsp;".
				"<input type='button' class='formbutton' value='".$GLOBALS['payment_lang']['verify']."' id='verify_ecv' ></span>";				
		return $html;
	}
