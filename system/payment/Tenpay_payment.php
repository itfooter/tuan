...
class Tenpay_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_return_url = get_domain().APP_ROOT.'/payment.php?act=return&class_name=Tenpay';
		...
		$payLinks .= "<input type='submit' class='paybutton' value='".$GLOBALS['payment_lang']['GO_TO_PAY']."'></form>";
	...
	{
		$payment_item = $GLOBALS['db']->getRowCached("select * from ".DB_PREFIX."payment where class_name='Tenpay'");
		if($payment_item)
		{
