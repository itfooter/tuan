...
class Paypal_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_return_url = get_domain().APP_ROOT.'/payment.php?act=return&class_name=Paypal';
		$data_notify_url = get_domain().APP_ROOT.'/payment.php?act=notify&class_name=Paypal';
	...
	{
		$payment_item = $GLOBALS['db']->getRowCached("select * from ".DB_PREFIX."payment where class_name='Paypal'");
		if($payment_item)
		{
