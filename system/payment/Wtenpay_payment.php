...
class Wtenpay_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_return_url = get_domain().APP_ROOT.'/../shop.php?ctl=payment&act=response&class_name=Wtenpay';
		$notify_url = get_domain().APP_ROOT.'/../shop.php?ctl=payment&act=notify&class_name=Wtenpay';
