...
class Fedex_express implements express {
	...
	{
		$express_module = $GLOBALS['db']->getRowCached("select * from ".DB_PREFIX."express where class_name = 'Fedex'");
		...
		$order_info['region_lv1_name'] = $GLOBALS['db']->getOneCached("select name from ".DB_PREFIX."delivery_region where id = ".intval($order_info['region_lv1']));
		$order_info['region_lv2_name'] = $GLOBALS['db']->getOneCached("select name from ".DB_PREFIX."delivery_region where id = ".intval($order_info['region_lv2']));
		$order_info['region_lv3_name'] = $GLOBALS['db']->getOneCached("select name from ".DB_PREFIX."delivery_region where id = ".intval($order_info['region_lv3']));
		$order_info['region_lv4_name'] = $GLOBALS['db']->getOneCached("select name from ".DB_PREFIX."delivery_region where id = ".intval($order_info['region_lv4']));
